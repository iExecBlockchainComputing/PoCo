...
module.exports = {
	...
	EIP712DOMAIN_SEPARATOR: null,
	   EIP712DOMAIN_TYPEHASH:  web3.utils.keccak256("EIP712Domain(string name,string version,uint256 chainId,address verifyingContract)"),
	       APPORDER_TYPEHASH:     web3.utils.keccak256("AppOrder(address app,uint256 appprice,uint256 volume,uint256 tag,address datasetrestrict,address workerpoolrestrict,address requestorrestrict,bytes32 salt)"),
	   DATASETORDER_TYPEHASH:     web3.utils.keccak256("DatasetOrder(address dataset,uint256 datasetprice,uint256 volume,uint256 tag,address apprestrict,address workerpoolrestrict,address requestorrestrict,bytes32 salt)"),
	WORKERPOOLORDER_TYPEHASH:     web3.utils.keccak256("WorkerpoolOrder(address workerpool,uint256 workerpoolprice,uint256 volume,uint256 tag,uint256 category,uint256 trust,address apprestrict,address datasetrestrict,address requestorrestrict,bytes32 salt)"),
	...
	DatasetOrderStructHash: function(datasetorder)
	{
		return web3.utils.keccak256(web3.eth.abi.encodeParameters([
			...
			datasetorder.requestorrestrict,
			datasetorder.salt,
		]));
	},
	WorkerpoolOrderStructHash: function(workerpoolorder)
	{
		return web3.utils.keccak256(web3.eth.abi.encodeParameters([
			...
			workerpoolorder.requestorrestrict,
