...
## [6.2.0](https://github.com/iExecBlockchainComputing/PoCo/compare/poco-v6.1.0...poco-v6.2.0) (2025-11-13)


### 🔧 Improvements

* **contracts:** Upgrade all contracts to Solidity v0.8.0 ([#287](https://github.com/iExecBlockchainComputing/PoCo/issues/287)) ([55729ad](https://github.com/iExecBlockchainComputing/PoCo/commit/55729ad8e2a53fb24ed8d8b3405147baec9d6d9f))
* **tooling:** Remove TokenSwap facet and cleanup unused contracts ([#311](https://github.com/iExecBlockchainComputing/PoCo/issues/311), [#315](https://github.com/iExecBlockchainComputing/PoCo/issues/315))
* **formatting:** Format all files and improve code consistency ([#307](https://github.com/iExecBlockchainComputing/PoCo/issues/307))

## [6.1.0](https://github.com/iExecBlockchainComputing/PoCo/compare/poco-v6.0.0...poco-v6.1.0) (2025-11-13)

### 🌐 Network Support

* **Arbitrum One:** Deployed on Arbitrum mainnet ([#248](https://github.com/iExecBlockchainComputing/PoCo/issues/248), [#249](https://github.com/iExecBlockchainComputing/PoCo/issues/249))
* **Arbitrum Sepolia:** Testnet deployment ([#246](https://github.com/iExecBlockchainComputing/PoCo/issues/246))
* **Multi-chain CI/CD:** Automated deployment workflow ([#218](https://github.com/iExecBlockchainComputing/PoCo/issues/218))
...
* **SDK Compatibility:** Restore `setName` as nonpayable function ([#286](https://github.com/iExecBlockchainComputing/PoCo/issues/286), [#240](https://github.com/iExecBlockchainComputing/PoCo/issues/240))
* **View Functions:** Add asset inspection capabilities ([#262](https://github.com/iExecBlockchainComputing/PoCo/issues/262))

### 🏗️ Architecture

* **Diamond Proxy (ERC-2535):** Complete migration from ERC-1538 ([#241](https://github.com/iExecBlockchainComputing/PoCo/issues/241))
  * Namespaced storage implementation ([#236](https://github.com/iExecBlockchainComputing/PoCo/issues/236))
  * Storage library refactoring ([#243](https://github.com/iExecBlockchainComputing/PoCo/issues/243))
  * Refactor naming throughout codebase ([#229](https://github.com/iExecBlockchainComputing/PoCo/issues/229), [#230](https://github.com/iExecBlockchainComputing/PoCo/issues/230), [#234](https://github.com/iExecBlockchainComputing/PoCo/issues/234))
  * Restructure contracts directory ([#238](https://github.com/iExecBlockchainComputing/PoCo/issues/238))
...
* **ENS Removal:** Clean up ENS modules and dependencies ([#225](https://github.com/iExecBlockchainComputing/PoCo/issues/225))
* **Boost Management:** Remove boost facets from testnet ([#299](https://github.com/iExecBlockchainComputing/PoCo/issues/299))

### 🔧 Developer Experience

* **Deployment:**
  * CreateX factory integration ([#216](https://github.com/iExecBlockchainComputing/PoCo/issues/216))
  * Set owner at deployment ([#245](https://github.com/iExecBlockchainComputing/PoCo/issues/245))
  * Save IexecLibOrders_v5 in config ([#242](https://github.com/iExecBlockchainComputing/PoCo/issues/242))
* **Tooling & CI/CD:**
...
* **Dependencies:**
  ...
  * Target latest EVM version ([#239](https://github.com/iExecBlockchainComputing/PoCo/issues/239))

### 📦 Distribution

* **NPM Package:** Published for v6.1.0 with automated publishing on tags ([#247](https://github.com/iExecBlockchainComputing/PoCo/issues/247))
...
* **Upgrade Scripts:** Improved facet upgrade tooling ([#235](https://github.com/iExecBlockchainComputing/PoCo/issues/235), [#298](https://github.com/iExecBlockchainComputing/PoCo/issues/298))
