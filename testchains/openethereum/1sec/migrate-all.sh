...
nohup /home/openethereum/openethereum --chain /iexec-poco/testchains/openethereum/1sec/spec.json --config /iexec-poco/testchains/openethereum/1sec/authority.toml -d /iexec-poco/testchains/openethereum/1sec/data --geth > deployed.txt 2>&1 &
sleep 4
