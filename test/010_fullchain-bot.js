...
contract('IexecHub', async (accounts) => {
	...
	it(">> initialize", async () => {
		for (taskid in tasks)
		{
			...
			tasks[taskid].woid = events[0].args.woid;
		}
	});
	...
	it("[Revealed] Check balances", async () => {
		...
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker1  )).map(x => x.toNumber()), [ 1000 - 10 -  8 +  0 -  8, 10 +  8 +  0 +  8 ], "check balance");
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker2  )).map(x => x.toNumber()), [ 1000 - 10 -  8 -  8 -  8, 10 +  8 +  8 +  8 ], "check balance");
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker3  )).map(x => x.toNumber()), [ 1000 - 10 +  0 -  8 -  8, 10 +  0 +  8 +  8 ], "check balance");
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker4  )).map(x => x.toNumber()), [ 1000 - 10 +  0 -  8 -  8, 10 +  0 +  8 +  8 ], "check balance");
	...
	it("[Finalized 1] Check balances", async () => {
		...
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker1  )).map(x => x.toNumber()), [ 1000 - 10 + 11 +  0 -  8, 10 +  0 +  8 ], "check balance");
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker2  )).map(x => x.toNumber()), [ 1000 - 10 + 11 -  8 -  8, 10 +  8 +  8 ], "check balance");
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker3  )).map(x => x.toNumber()), [ 1000 - 10 +  0 -  8 -  8, 10 +  8 +  8 ], "check balance");
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker4  )).map(x => x.toNumber()), [ 1000 - 10 +  0 -  8 -  8, 10 +  8 +  8 ], "check balance");
	...
	it("[Finalized 2] Check balances", async () => {
		...
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker1  )).map(x => x.toNumber()), [ 1000 - 10 + 11 +  0 -  8, 10 +  8 ], "check balance");
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker2  )).map(x => x.toNumber()), [ 1000 - 10 + 11 +  7 -  8, 10 +  8 ], "check balance");
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker3  )).map(x => x.toNumber()), [ 1000 - 10 +  0 +  7 -  8, 10 +  8 ], "check balance");
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker4  )).map(x => x.toNumber()), [ 1000 - 10 +  0 +  7 -  8, 10 +  8 ], "check balance");
	...
	it("[Finalized 3] Check balances", async () => {
		...
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker1  )).map(x => x.toNumber()), [ 1000 - 10 + 11 +  0 + 10, 10 ], "check balance");
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker2  )).map(x => x.toNumber()), [ 1000 - 10 + 11 +  7 + 10, 10 ], "check balance");
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker3  )).map(x => x.toNumber()), [ 1000 - 10 +  0 +  7 -  8, 10 ], "check balance");
		assert.deepEqual((await IexecClerkInstance.viewAccountLegacy(poolWorker4  )).map(x => x.toNumber()), [ 1000 - 10 +  0 +  7 + 10, 10 ], "check balance");
