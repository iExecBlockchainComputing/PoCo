...
contract('IexecHub', function(accounts) {
  ...
  it("Create bid Marker Order by user", async function() {
    ...
    [direction,category,trust,marketDeadline,assetDeadline,value,volume,remaining,requester,workerpool] = await aIexecHubInstance.getMarketOrder.call(1);
    assert.strictEqual(direction.toNumber(), IexecLib.MarketOrderDirectionEnum.BID, "check IexecLib.MarketOrderDirectionEnum.BID");
    ...
    assert.strictEqual(requester, iExecCloudUser, "check requester");
    assert.strictEqual(workerpool, '0x0000000000000000000000000000000000000000', "check workerpool 0 = any");
