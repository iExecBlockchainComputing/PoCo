...
contract('IexecHub', function(accounts) {
  ...
  it("addApp_01 : nobody can call addApp : addApp internal function", async function() {
    assert.strictEqual(aAppHubInstance.contract.addApp, undefined, "expected addApp internal");
  });
