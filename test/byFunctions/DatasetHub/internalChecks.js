...
contract('IexecHub', function(accounts) {
  ...
  it("addDataset_01 : nobody can call addDataset : addDataset internal function", async function() {
    assert.strictEqual(aDatasetHubInstance.contract.addDataset, undefined, "expected addDataset internal");
  });
