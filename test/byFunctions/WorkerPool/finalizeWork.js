...
contract('IexecHub', function(accounts) {
  ...
  it("finalizeWork_07: 2 workers good contribution : resourceProvider, resourceProvider2.1 worker wrong contribution :resourceProvider3 and  scheduler and 2 worker are rewarded. Then test workers score impact", async function() {
    ...
    [poolReward, stakeAmount, consensus, revealDate, revealCounter, consensusTimout, winnerCount] = await aWorkerPoolInstance.getConsensusDetails.call(woid3, {
      from: iExecCloudUser,
      gas: constants.AMOUNT_GAS_PROVIDED
    });
  ...
  it("finalizeWork_08: can't finalizeWork  after consensusTimout", async function() {
