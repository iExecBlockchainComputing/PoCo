...
contract('IexecHub', function(accounts) {
  ...
  it("resourceProvider can Subscribe if he has enought deposit", async function() {
  ...
  it("resourceProvider can't Subscribe to an other pool if already affected to one pool", async function() {
  ...
  it("resourceProvider can't  Subscribe if he has not enought deposit", async function() {
