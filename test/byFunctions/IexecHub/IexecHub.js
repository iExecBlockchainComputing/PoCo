...
contract('IexecHub', async (accounts) => {
	...
	it("IexecHub: internal methods", async function() {
		assert.strictEqual(IexecClerkInstance.contract.__distributeRewards, undefined, "expected __distributeRewards internal");
	});
