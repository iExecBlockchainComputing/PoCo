...
contract('IexecClerk', async (accounts) => {
	...
	it("check app hash", async () => {
		...
		assert.isTrue       (await IexecClerkInstance.verifySignature(appProvider, odbtools.typedStructHash(odbtools.AppOrderStructHash(apporder)), apporder.sign, {}), "Error with the validation of the apporder signature");
		assert.isTrue       (await IexecClerkInstance.verifySignature(appProvider, odbtools.typedStructHash(odbtools.AppOrderStructHash({ app: apporder.app,           appprice: apporder.appprice, volume: apporder.volume, tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: apporder.workerpoolrestrict, requesterrestrict: apporder.requesterrestrict, salt: apporder.salt            })), apporder.sign,            {}));
		await shouldFail.reverting(IexecClerkInstance.verifySignature(appProvider, odbtools.typedStructHash(odbtools.AppOrderStructHash({ app: constants.NULL.ADDRESS, appprice: apporder.appprice, volume: apporder.volume, tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: apporder.workerpoolrestrict, requesterrestrict: apporder.requesterrestrict, salt: apporder.salt            })), apporder.sign,            {}));
	...
	it("check dataset hash", async () => {
		...
		assert.isTrue       (await IexecClerkInstance.verifySignature(datasetProvider, odbtools.typedStructHash(odbtools.DatasetOrderStructHash(datasetorder)), datasetorder.sign, {}), "Error with the validation of the datasetorder signature");
		assert.isTrue       (await IexecClerkInstance.verifySignature(datasetProvider, odbtools.typedStructHash(odbtools.DatasetOrderStructHash({ dataset: datasetorder.dataset,   datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        })), datasetorder.sign,        {}));
		await shouldFail.reverting(IexecClerkInstance.verifySignature(datasetProvider, odbtools.typedStructHash(odbtools.DatasetOrderStructHash({ dataset: constants.NULL.ADDRESS, datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        })), datasetorder.sign,        {}));
	...
	it("check workerpool hash", async () => {
		...
		assert.isTrue       (await IexecClerkInstance.verifySignature(scheduler, odbtools.typedStructHash(odbtools.WorkerpoolOrderStructHash(workerpoolorder)), workerpoolorder.sign, {}), "Error with the validation of the workerpoolorder signature");
		assert.isTrue       (await IexecClerkInstance.verifySignature(scheduler, odbtools.typedStructHash(odbtools.WorkerpoolOrderStructHash({ workerpool: workerpoolorder.workerpool, workerpoolprice: workerpoolorder.workerpoolprice, volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requesterrestrict: workerpoolorder.requesterrestrict, salt: workerpoolorder.salt     })), workerpoolorder.sign,     {}));
		await shouldFail.reverting(IexecClerkInstance.verifySignature(scheduler, odbtools.typedStructHash(odbtools.WorkerpoolOrderStructHash({ workerpool: constants.NULL.ADDRESS,     workerpoolprice: workerpoolorder.workerpoolprice, volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requesterrestrict: workerpoolorder.requesterrestrict, salt: workerpoolorder.salt     })), workerpoolorder.sign,     {}));
		await shouldFail.reverting(IexecClerkInstance.verifySignature(scheduler, odbtools.typedStructHash(odbtools.WorkerpoolOrderStructHash({ workerpool: workerpoolorder.workerpool, workerpoolprice: 0,                               volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requesterrestrict: workerpoolorder.requesterrestrict, salt: workerpoolorder.salt     })), workerpoolorder.sign,     {}));
	...
	it("check request hash", async () => {
		...
		assert.isTrue       (await IexecClerkInstance.verifySignature(user, odbtools.typedStructHash(odbtools.RequestOrderStructHash(requestorder)), requestorder.sign, {}), "Error with the validation of the requestorder signature");
		assert.isTrue       (await IexecClerkInstance.verifySignature(user, odbtools.typedStructHash(odbtools.RequestOrderStructHash({ app: requestorder.app,       appmaxprice: requestorder.appmaxprice, dataset: requestorder.dataset,   datasetmaxprice: requestorder.datasetmaxprice, workerpool: requestorder.workerpool, workerpoolmaxprice: requestorder.workerpoolmaxprice, volume: requestorder.volume, category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        })), requestorder.sign,        {}));
		await shouldFail.reverting(IexecClerkInstance.verifySignature(user, odbtools.typedStructHash(odbtools.RequestOrderStructHash({ app: constants.NULL.ADDRESS, appmaxprice: requestorder.appmaxprice, dataset: requestorder.dataset,   datasetmaxprice: requestorder.datasetmaxprice, workerpool: requestorder.workerpool, workerpoolmaxprice: requestorder.workerpoolmaxprice, volume: requestorder.volume, category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        })), requestorder.sign,        {}));
		await shouldFail.reverting(IexecClerkInstance.verifySignature(user, odbtools.typedStructHash(odbtools.RequestOrderStructHash({ app: requestorder.app,       appmaxprice: 1000,                     dataset: requestorder.dataset,   datasetmaxprice: requestorder.datasetmaxprice, workerpool: requestorder.workerpool, workerpoolmaxprice: requestorder.workerpoolmaxprice, volume: requestorder.volume, category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        })), requestorder.sign,        {}));
		await shouldFail.reverting(IexecClerkInstance.verifySignature(user, odbtools.typedStructHash(odbtools.RequestOrderStructHash({ app: requestorder.app,       appmaxprice: requestorder.appmaxprice, dataset: constants.NULL.ADDRESS, datasetmaxprice: requestorder.datasetmaxprice, workerpool: requestorder.workerpool, workerpoolmaxprice: requestorder.workerpoolmaxprice, volume: requestorder.volume, category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        })), requestorder.sign,        {}));
		await shouldFail.reverting(IexecClerkInstance.verifySignature(user, odbtools.typedStructHash(odbtools.RequestOrderStructHash({ app: requestorder.app,       appmaxprice: requestorder.appmaxprice, dataset: requestorder.dataset,   datasetmaxprice: 1000,                         workerpool: requestorder.workerpool, workerpoolmaxprice: requestorder.workerpoolmaxprice, volume: requestorder.volume, category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        })), requestorder.sign,        {}));
		await shouldFail.reverting(IexecClerkInstance.verifySignature(user, odbtools.typedStructHash(odbtools.RequestOrderStructHash({ app: requestorder.app,       appmaxprice: requestorder.appmaxprice, dataset: requestorder.dataset,   datasetmaxprice: requestorder.datasetmaxprice, workerpool: constants.NULL.ADDRESS,  workerpoolmaxprice: requestorder.workerpoolmaxprice, volume: requestorder.volume, category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        })), requestorder.sign,        {}));
		await shouldFail.reverting(IexecClerkInstance.verifySignature(user, odbtools.typedStructHash(odbtools.RequestOrderStructHash({ app: requestorder.app,       appmaxprice: requestorder.appmaxprice, dataset: requestorder.dataset,   datasetmaxprice: requestorder.datasetmaxprice, workerpool: requestorder.workerpool, workerpoolmaxprice: 1000,                            volume: requestorder.volume, category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        })), requestorder.sign,        {}));
		await shouldFail.reverting(IexecClerkInstance.verifySignature(user, odbtools.typedStructHash(odbtools.RequestOrderStructHash({ app: requestorder.app,       appmaxprice: requestorder.appmaxprice, dataset: requestorder.dataset,   datasetmaxprice: requestorder.datasetmaxprice, workerpool: requestorder.workerpool, workerpoolmaxprice: requestorder.workerpoolmaxprice, volume: 0xFFFFFF,            category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        })), requestorder.sign,        {}));
