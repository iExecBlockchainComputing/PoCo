...
contract('IexecHub', async (accounts) => {
	...
	it("check app hash", async () => {
		...
		assert.isFalse(await IexecClerkInstance.verify(appProvider, odbtools.AppOrderStructHash({ app: apporder.app,           appprice: apporder.appprice, volume: apporder.volume, tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: constants.NULL.ADDRESS,      requestorrestrict: apporder.requestorrestrict, salt: apporder.salt            }), apporder.sign,            {}));
		assert.isFalse(await IexecClerkInstance.verify(appProvider, odbtools.AppOrderStructHash({ app: apporder.app,           appprice: apporder.appprice, volume: apporder.volume, tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: apporder.workerpoolrestrict, requestorrestrict: constants.NULL.ADDRESS,     salt: apporder.salt            }), apporder.sign,            {}));
		assert.isFalse(await IexecClerkInstance.verify(appProvider, odbtools.AppOrderStructHash({ app: apporder.app,           appprice: apporder.appprice, volume: apporder.volume, tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: apporder.workerpoolrestrict, requestorrestrict: apporder.requestorrestrict, salt: web3.utils.randomHex(32) }), apporder.sign,            {}));
		assert.isFalse(await IexecClerkInstance.verify(appProvider, odbtools.AppOrderStructHash({ app: apporder.app,           appprice: apporder.appprice, volume: apporder.volume, tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: apporder.workerpoolrestrict, requestorrestrict: apporder.requestorrestrict, salt: apporder.salt            }), constants.NULL.SIGNATURE, {}));
	});
	...
	it("check dataset hash", async () => {
		...
		assert.isFalse(await IexecClerkInstance.verify(datasetProvider, odbtools.DatasetOrderStructHash({ dataset: datasetorder.dataset,   datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: constants.NULL.ADDRESS,          requestorrestrict: datasetorder.requestorrestrict, salt: datasetorder.salt        }), datasetorder.sign,        {}));
		assert.isFalse(await IexecClerkInstance.verify(datasetProvider, odbtools.DatasetOrderStructHash({ dataset: datasetorder.dataset,   datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requestorrestrict: constants.NULL.ADDRESS,         salt: datasetorder.salt        }), datasetorder.sign,        {}));
		assert.isFalse(await IexecClerkInstance.verify(datasetProvider, odbtools.DatasetOrderStructHash({ dataset: datasetorder.dataset,   datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requestorrestrict: datasetorder.requestorrestrict, salt: web3.utils.randomHex(32) }), datasetorder.sign,        {}));
		assert.isFalse(await IexecClerkInstance.verify(datasetProvider, odbtools.DatasetOrderStructHash({ dataset: datasetorder.dataset,   datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requestorrestrict: datasetorder.requestorrestrict, salt: datasetorder.salt        }), constants.NULL.SIGNATURE, {}));
	});
	...
	it("check workerpool hash", async () => {
		...
		assert.isTrue (await IexecClerkInstance.verify(scheduler, odbtools.WorkerpoolOrderStructHash({ workerpool: workerpoolorder.workerpool, workerpoolprice: workerpoolorder.workerpoolprice, volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requestorrestrict: workerpoolorder.requestorrestrict, salt: workerpoolorder.salt     }), workerpoolorder.sign,     {}));
		assert.isFalse(await IexecClerkInstance.verify(scheduler, odbtools.WorkerpoolOrderStructHash({ workerpool: constants.NULL.ADDRESS,     workerpoolprice: workerpoolorder.workerpoolprice, volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requestorrestrict: workerpoolorder.requestorrestrict, salt: workerpoolorder.salt     }), workerpoolorder.sign,     {}));
		assert.isFalse(await IexecClerkInstance.verify(scheduler, odbtools.WorkerpoolOrderStructHash({ workerpool: workerpoolorder.workerpool, workerpoolprice: 0,                               volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requestorrestrict: workerpoolorder.requestorrestrict, salt: workerpoolorder.salt     }), workerpoolorder.sign,     {}));
		assert.isFalse(await IexecClerkInstance.verify(scheduler, odbtools.WorkerpoolOrderStructHash({ workerpool: workerpoolorder.workerpool, workerpoolprice: workerpoolorder.workerpoolprice, volume: 0xFFFFFF,               category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requestorrestrict: workerpoolorder.requestorrestrict, salt: workerpoolorder.salt     }), workerpoolorder.sign,     {}));
		assert.isFalse(await IexecClerkInstance.verify(scheduler, odbtools.WorkerpoolOrderStructHash({ workerpool: workerpoolorder.workerpool, workerpoolprice: workerpoolorder.workerpoolprice, volume: workerpoolorder.volume, category: 5,                        trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requestorrestrict: workerpoolorder.requestorrestrict, salt: workerpoolorder.salt     }), workerpoolorder.sign,     {}));
		assert.isFalse(await IexecClerkInstance.verify(scheduler, odbtools.WorkerpoolOrderStructHash({ workerpool: workerpoolorder.workerpool, workerpoolprice: workerpoolorder.workerpoolprice, volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: 1,                   apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requestorrestrict: workerpoolorder.requestorrestrict, salt: workerpoolorder.salt     }), workerpoolorder.sign,     {}));
		assert.isFalse(await IexecClerkInstance.verify(scheduler, odbtools.WorkerpoolOrderStructHash({ workerpool: workerpoolorder.workerpool, workerpoolprice: workerpoolorder.workerpoolprice, volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: constants.NULL.ADDRESS,      datasetrestrict: workerpoolorder.datasetrestrict, requestorrestrict: workerpoolorder.requestorrestrict, salt: workerpoolorder.salt     }), workerpoolorder.sign,     {}));
		assert.isFalse(await IexecClerkInstance.verify(scheduler, odbtools.WorkerpoolOrderStructHash({ workerpool: workerpoolorder.workerpool, workerpoolprice: workerpoolorder.workerpoolprice, volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: constants.NULL.ADDRESS,          requestorrestrict: workerpoolorder.requestorrestrict, salt: workerpoolorder.salt     }), workerpoolorder.sign,     {}));
		assert.isFalse(await IexecClerkInstance.verify(scheduler, odbtools.WorkerpoolOrderStructHash({ workerpool: workerpoolorder.workerpool, workerpoolprice: workerpoolorder.workerpoolprice, volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requestorrestrict: constants.NULL.ADDRESS,            salt: workerpoolorder.salt     }), workerpoolorder.sign,     {}));
		assert.isFalse(await IexecClerkInstance.verify(scheduler, odbtools.WorkerpoolOrderStructHash({ workerpool: workerpoolorder.workerpool, workerpoolprice: workerpoolorder.workerpoolprice, volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requestorrestrict: workerpoolorder.requestorrestrict, salt: web3.utils.randomHex(32) }), workerpoolorder.sign,     {}));
		assert.isFalse(await IexecClerkInstance.verify(scheduler, odbtools.WorkerpoolOrderStructHash({ workerpool: workerpoolorder.workerpool, workerpoolprice: workerpoolorder.workerpoolprice, volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requestorrestrict: workerpoolorder.requestorrestrict, salt: workerpoolorder.salt     }), constants.NULL.SIGNATURE, {}));
	});
