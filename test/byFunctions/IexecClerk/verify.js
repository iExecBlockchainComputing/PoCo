...
contract('IexecHub', async (accounts) => {
	...
	it("check signature mechanism", async () => {
		...
		assert.isTrue   (await IexecClerkInstance.verifySignature(constants.NULL.ADDRESS, entry.hash,               { v: entry.sign.v, r: entry.sign.r,             s: entry.sign.s             }, {}), "Error with the validation of signatures");
