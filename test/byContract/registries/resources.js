            ...
            .map((_, i) => {
                describe(`app #${i}`, async () => {
                    ...
                    it('reverse registration', async () => {
                        ...
                        await AppInstances[i].setName(ENSInstance.address, ensname, {
                            from: appProvider.address,
                        });
            ...
            .map((_, i) => {
                describe(`dataset #${i}`, async () => {
                    it('creation', async () => {
                        ...
                        DatasetInstances[i] = await Dataset.at(
                            tools.BN2Address(
                                tools.extractEvents(
                                    txMined,
                    ...
                    it('reverse registration', async () => {
                        ...
                        await DatasetInstances[i].setName(ENSInstance.address, ensname, {
                            from: datasetProvider.address,
                        });
    ...
    describe('Workerpools', async () => {
            ...
            .map((_, i) => {
                describe(`workerpool #${i}`, async () => {
                    it('creation', async () => {
                        ...
                        WorkerpoolInstances[i] = await Workerpool.at(
                            tools.BN2Address(
                                tools.extractEvents(
                                    txMined,
                    ...
                    it('reverse registration', async () => {
                        ...
                        await WorkerpoolInstances[i].setName(ENSInstance.address, ensname, {
                            from: scheduler.address,
                        });
                        assert.equal(
                            await enstools.lookup(WorkerpoolInstances[i].address),
                            ensname,
                        );
                    });
                });
        ...
        describe('configuration', async () => {
            it('owner can configure', async () => {
                ...
                assert.equal(
                    await WorkerpoolInstances[1].m_workerpoolDescription(),
                    'Workerpool #1',
                );
            ...
            it('owner restriction apply', async () => {
                await expectRevert.unspecified(
                    WorkerpoolInstances[1].changePolicy(0, 0, { from: user.address }),
                );
            ...
            it('invalid configuration refused', async () => {
                await expectRevert.unspecified(
                    WorkerpoolInstances[1].changePolicy(
