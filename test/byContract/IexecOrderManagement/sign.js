...
contract('OrderManagement', async (accounts) => {
    ...
    describe('sign apporder', async () => {
        it('unauthorized sender', async () => {
            ...
            assert.equal(
                await IexecInstance.viewPresigned(hash),
                constants.NULL.ADDRESS,
                'Error in app order presign',
            );
            await expectRevert.unspecified(
                IexecInstance.manageAppOrder(apporderoperation, { from: iexecAdmin.address }),
            );
            assert.equal(
                await IexecInstance.viewPresigned(hash),
                constants.NULL.ADDRESS,
    ...
    describe('sign datasetorder', async () => {
        it('unauthorized sender', async () => {
            ...
            assert.equal(
                await IexecInstance.viewPresigned(hash),
                constants.NULL.ADDRESS,
                'Error in dataset order presign',
            );
            await expectRevert.unspecified(
                IexecInstance.manageDatasetOrder(datasetorderoperation, {
                    from: iexecAdmin.address,
                }),
            );
            assert.equal(
        ...
        it('authorized signature', async () => {
            ...
            await IexecInstance.manageDatasetOrder(datasetorderoperation, {
                from: iexecAdmin.address,
            });
            assert.equal(
                await IexecInstance.viewPresigned(hash),
    ...
    describe('sign workerpoolorder', async () => {
        it('unauthorized sender', async () => {
            ...
            assert.equal(
                await IexecInstance.viewPresigned(hash),
                constants.NULL.ADDRESS,
                'Error in workerpool order presign',
            );
            await expectRevert.unspecified(
                IexecInstance.manageWorkerpoolOrder(workerpoolorderoperation, {
                    from: iexecAdmin.address,
                }),
            );
            assert.equal(
        ...
        it('authorized signature', async () => {
            ...
            await IexecInstance.manageWorkerpoolOrder(workerpoolorderoperation, {
                from: iexecAdmin.address,
            });
            assert.equal(
                await IexecInstance.viewPresigned(hash),
    ...
    describe('sign requestorder', async () => {
        it('unauthorized sender', async () => {
            ...
            assert.equal(
                await IexecInstance.viewPresigned(hash),
                constants.NULL.ADDRESS,
                'Error in request order presign',
            );
            await expectRevert.unspecified(
                IexecInstance.manageRequestOrder(requestorderoperation, {
                    from: iexecAdmin.address,
                }),
            );
            assert.equal(
        ...
        it('authorized signature', async () => {
            ...
            await IexecInstance.manageRequestOrder(requestorderoperation, {
                from: iexecAdmin.address,
            });
            assert.equal(
                await IexecInstance.viewPresigned(hash),
    ...
    describe('matching presigned orders', async () => {
        it('match', async () => {
            ...
            await IexecInstance.manageAppOrder(
                {
                    order: apporder,
                    operation: constants.OrderOperationEnum.SIGN,
                    sign: constants.NULL.SIGNATURE,
            ...
            await IexecInstance.manageDatasetOrder(
                {
                    order: datasetorder,
                    operation: constants.OrderOperationEnum.SIGN,
                    sign: constants.NULL.SIGNATURE,
            ...
            await IexecInstance.manageWorkerpoolOrder(
                {
                    order: workerpoolorder,
                    operation: constants.OrderOperationEnum.SIGN,
                    sign: constants.NULL.SIGNATURE,
            ...
            await IexecInstance.manageRequestOrder(
                {
                    order: requestorder,
                    operation: constants.OrderOperationEnum.SIGN,
                    sign: constants.NULL.SIGNATURE,
