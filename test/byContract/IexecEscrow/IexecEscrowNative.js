...
if (DEPLOYMENT.asset == 'Native')
    contract('EscrowNative', async (accounts) => {
        ...
        describe('fallback', async () => {
            it('success', async () => {
                assert.equal(
                    await web3.eth.getBalance(IexecInstance.address),
                    migrationBalance + 0 * 10 ** 9,
                );
                assert.deepEqual(
                    Object.extract(await IexecInstance.viewAccount(accounts[0]), [
                        'stake',
                        'locked',
                    ]).map((bn) => Number(bn)),
                    [0, 0],
        ...
        describe('depositFor', async () => {
            it('success', async () => {
                ...
                txMined = await IexecInstance.depositFor(accounts[3], {
                    from: accounts[2],
                    value: 100 * 10 ** 9,
                });
        ...
        describe('depositForArray', async () => {
            describe('length missmatch', () => {
                describe('amounts.length > target.length', () => {
                    it('reverts', async () => {
                        ...
                        assert.deepEqual(
                            Object.extract(await IexecInstance.viewAccount(accounts[4]), [
                                'stake',
                                'locked',
                            ]).map((bn) => Number(bn)),
                            [0, 0],
                        ...
                        await expectRevert.unspecified(
                            IexecInstance.depositForArray([100, 100], [accounts[5]], {
                                from: accounts[4],
                                value: 200 * 10 ** 9,
                            }),
                        );
                ...
                describe('amounts.length > target.length', () => {
                    it('reverts', async () => {
                        ...
                        await expectRevert.unspecified(
                            IexecInstance.depositForArray([100], [accounts[5], accounts[6]], {
                                from: accounts[4],
                                value: 200 * 10 ** 9,
                            }),
                        );
            ...
            describe('excess value', () => {
                it('success', async () => {
                    ...
                    assert.deepEqual(
                        Object.extract(await IexecInstance.viewAccount(accounts[8]), [
                            'stake',
                            'locked',
                        ]).map((bn) => Number(bn)),
                        [0, 0],
                    ...
                    assert.deepEqual(
                        Object.extract(await IexecInstance.viewAccount(accounts[9]), [
                            'stake',
                            'locked',
                        ]).map((bn) => Number(bn)),
                        [0, 0],
        ...
        describe('withdraw', async () => {
            ...
            describe('insufficient balance', async () => {
                it('reverts', async () => {
                    ...
                    await expectRevert.unspecified(
                        IexecInstance.withdraw(1000, { from: accounts[0] }),
                    );
