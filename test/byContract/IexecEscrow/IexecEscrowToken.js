    ...
    contract('EscrowToken', async (accounts) => {
        ...
        describe('deposit', async () => {
            describe('no tokens', async () => {
                it('reverts', async () => {
                    ...
                    assert.deepEqual(
                        Object.extract(await IexecInstance.viewAccount(accounts[1]), [
                            'stake',
                            'locked',
                        ]).map((bn) => Number(bn)),
                        [0, 0],
                    ...
                    await expectRevert.unspecified(
                        IexecInstance.deposit(100, { from: accounts[1] }),
                    );
            ...
            describe('not approved', async () => {
                it('reverts', async () => {
                    ...
                    assert.equal(
                        await RLCInstance.balanceOf(accounts[1]),
                        100,
                        'wrong rlc balance',
                    );
                    assert.deepEqual(
        ...
        describe('depositFor', async () => {
            describe('no tokens', async () => {
                it('reverts', async () => {
                    ...
                    assert.deepEqual(
                        Object.extract(await IexecInstance.viewAccount(accounts[3]), [
                            'stake',
                            'locked',
                        ]).map((bn) => Number(bn)),
                        [0, 0],
                    ...
                    await expectRevert.unspecified(
                        IexecInstance.depositFor(100, accounts[3], { from: accounts[2] }),
                    );
            ...
            describe('not approved', async () => {
                it('reverts', async () => {
                    ...
                    assert.equal(
                        await RLCInstance.balanceOf(accounts[2]),
                        100,
                        'wrong rlc balance',
                    );
                    assert.deepEqual(
            ...
            describe('approved', async () => {
                it('success', async () => {
                    ...
                    txMined = await IexecInstance.depositFor(100, accounts[3], {
                        from: accounts[2],
                    });
        ...
        describe('depositForArray', async () => {
            describe('no tokens', async () => {
                it('reverts', async () => {
                    ...
                    assert.deepEqual(
                        Object.extract(await IexecInstance.viewAccount(accounts[5]), [
                            'stake',
                            'locked',
                        ]).map((bn) => Number(bn)),
                        [0, 0],
                    ...
                    assert.deepEqual(
                        Object.extract(await IexecInstance.viewAccount(accounts[6]), [
                            'stake',
                            'locked',
                        ]).map((bn) => Number(bn)),
                        [0, 0],
                    ...
                    assert.deepEqual(
                        Object.extract(await IexecInstance.viewAccount(accounts[7]), [
                            'stake',
                            'locked',
                        ]).map((bn) => Number(bn)),
                        [0, 0],
            ...
            describe('not approved', async () => {
                it('reverts', async () => {
                    ...
                    assert.equal(
                        await RLCInstance.balanceOf(accounts[4]),
                        300,
                        'wrong rlc balance',
                    );
                    assert.deepEqual(
                ...
                describe('length missmatch', () => {
                    describe('amounts.length > target.length', () => {
                        it('reverts', async () => {
                            ...
                            await RLCInstance.approve(IexecInstance.address, 300, {
                                from: accounts[4],
                            });

                            await expectRevert.unspecified(
                                IexecInstance.depositForArray([100, 100, 100], [accounts[5]], {
                                    from: accounts[4],
                                }),
                            );
        ...
        describe('ApproveAndCall', async () => {
            it('success', async () => {
                ...
                await RLCInstance.approveAndCall(IexecInstance.address, amount, '0x', {
                    from: accounts[0],
                });

                assert.equal(
                    await RLCInstance.balanceOf(accounts[0]),
                    balanceBefore.sub(amount).toString(),
                );
                assert.equal(
                    await IexecInstance.balanceOf(accounts[0]),
                    accountBefore.add(amount).toString(),
                );
            });
            ...
            describe('wrong token protection', async () => {
                ...
                it('reverts', async () => {
                    ...
                    await expectRevert.assertion(
                        DummyToken.approveAndCall(IexecInstance.address, amount, '0x', {
                            from: accounts[9],
                        }),
                    );
        ...
        describe('withdraw', async () => {
            describe('empty balance', async () => {
                it('reverts', async () => {
                    assert.equal(await RLCInstance.balanceOf(accounts[2]), 0, 'wrong rlc balance');
                    assert.deepEqual(
                        Object.extract(await IexecInstance.viewAccount(accounts[2]), [
                            'stake',
                            'locked',
                        ]).map((bn) => Number(bn)),
                        [0, 0],
                    ...
                    await expectRevert.unspecified(
                        IexecInstance.withdraw(100, { from: accounts[2] }),
                    );
            ...
            describe('insufficient balance', async () => {
                it('reverts', async () => {
                    ...
                    await expectRevert.unspecified(
                        IexecInstance.withdraw(1000, { from: accounts[1] }),
                    );
            ...
            describe('sufficient balance', async () => {
                it('success', async () => {
                    ...
                    assert.equal(
                        await RLCInstance.balanceOf(accounts[3]),
                        100,
                        'wrong rlc balance',
                    );
                    assert.deepEqual(
        ...
        describe('recover', async () => {
            describe('unauthorized access', async () => {
                it('reverts', async () => {
                    await expectRevert(
                        IexecInstance.recover({ from: accounts[9] }),
