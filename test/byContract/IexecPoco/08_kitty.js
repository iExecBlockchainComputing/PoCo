...
contract('Poco', async (accounts) => {
    ...
    describe('→ setup', async () => {
        describe('tokens', async () => {
            it('distribute', async () => {
                ...
                await IexecInstance.transfer(scheduler.address, 100000, {
                    from: iexecAdmin.address,
                });
    ...
    describe('→ drain Kitty', async () => {
        ...
        it('[8.5b] finalize', async () => {
            await IexecInstance.finalize(tasks[1], web3.utils.utf8ToHex('result'), '0x', {
                from: scheduler.address,
            });
        });
