...
contract('Poco', async (accounts) => {
    ...
    matchOrders = async (appextra, datasetextra, workerpoolextra, userextra) => {
        ...
        return IexecInstance.matchOrders(
            _apporder,
            _datasetorder,
            _workerpoolorder,
            _requestorder,
    ...
    it('[Match - Error - category]', async () => {
        await expectRevert.unspecified(matchOrders({}, {}, {}, { category: 5 }));
    });

    it('[Match - Error - trust]', async () => {
        await expectRevert.unspecified(matchOrders({}, {}, { trust: 100 }, {}));
    });

    it('[Match - Error - appprice]', async () => {
        await expectRevert.unspecified(matchOrders({ appprice: 1000 }, {}, {}, {}));
    });

    it('[Match - Error - datasetprice]', async () => {
        await expectRevert.unspecified(matchOrders({}, { datasetprice: 1000 }, {}, {}));
    });

    it('[Match - Error - workerpoolprice]', async () => {
        await expectRevert.unspecified(matchOrders({}, {}, { workerpoolprice: 1000 }, {}));
    });
    ...
    it('[Match - Error - requested app]', async () => {
        await expectRevert.unspecified(matchOrders({}, {}, {}, { app: user.address }));
    });

    it('[Match - Error - requested dataset]', async () => {
        await expectRevert.unspecified(matchOrders({}, {}, {}, { dataset: user.address }));
    });

    it('[Match - Error - workerpoolrequest]', async () => {
        await expectRevert.unspecified(matchOrders({}, {}, {}, { workerpool: user.address }));
    });

    it('[Match - Error - app-datasetrestrict]', async () => {
        await expectRevert.unspecified(matchOrders({ datasetrestrict: user.address }, {}, {}, {}));
    });
    it('[Match - Ok - app-datasetrestrict]', async () => {
        await matchOrders({ datasetrestrict: DatasetInstance.address }, {}, {}, {});
    });

    it('[Match - Error - app-workerpoolrestrict]', async () => {
        await expectRevert.unspecified(
            matchOrders({ workerpoolrestrict: user.address }, {}, {}, {}),
        );
    });
    it('[Match - Ok - app-workerpoolrestrict]', async () => {
        await matchOrders({ workerpoolrestrict: WorkerpoolInstance.address }, {}, {}, {});
    });

    it('[Match - Error - app-requesterrestrict]', async () => {
        await expectRevert.unspecified(
            matchOrders({ requesterrestrict: iexecAdmin.address }, {}, {}, {}),
        );
    });
    it('[Match - Ok - app-requesterrestrict]', async () => {
        await matchOrders({ requesterrestrict: user.address }, {}, {}, {});
    });

    it('[Match - Error - dataset-apprestrict]', async () => {
        await expectRevert.unspecified(matchOrders({}, { apprestrict: user.address }, {}, {}));
    });
    it('[Match - Ok - dataset-apprestrict]', async () => {
        await matchOrders({}, { apprestrict: AppInstance.address }, {}, {});
    });
    ...
    it('[Match - Error - volume null]', async () => {
        await expectRevert.unspecified(matchOrders({}, {}, {}, { volume: 0 }));
    });
});
