...
contract('Poco', async (accounts) => {
    ...
    it('[setup] Contribute', async () => {
        ...
        await sendContribution(
            ...
            await odbtools.utils.signAuthorization(
                { worker: worker1.address, taskid: tasks[4], enclave: constants.NULL.ADDRESS },
                scheduler.wallet,
            ),
            constants.NULL.ADDRESS,
        );
        await sendContribution(
            ...
            await odbtools.utils.signAuthorization(
                { worker: worker2.address, taskid: tasks[4], enclave: constants.NULL.ADDRESS },
                scheduler.wallet,
            ),
            constants.NULL.ADDRESS,
        );
        await sendContribution(
            ...
            await odbtools.utils.signAuthorization(
                { worker: worker3.address, taskid: tasks[4], enclave: constants.NULL.ADDRESS },
                scheduler.wallet,
            ),
            constants.NULL.ADDRESS,
        );
        await sendContribution(
            ...
            await odbtools.utils.signAuthorization(
                { worker: worker4.address, taskid: tasks[4], enclave: constants.NULL.ADDRESS },
                scheduler.wallet,
            ),
            constants.NULL.ADDRESS,
        );
        await sendContribution(
            ...
            await odbtools.utils.signAuthorization(
                { worker: worker5.address, taskid: tasks[4], enclave: constants.NULL.ADDRESS },
                scheduler.wallet,
            ),
            constants.NULL.ADDRESS,
        );
        ...
        await sendContribution(
            ...
            await odbtools.utils.signAuthorization(
                { worker: worker2.address, taskid: tasks[5], enclave: constants.NULL.ADDRESS },
                scheduler.wallet,
            ),
            constants.NULL.ADDRESS,
        );
    ...
    it('[3.4] Reveal - Error (contribution value)', async () => {
        await IexecInstance.reveal(tasks[4], odbtools.utils.hashResult(tasks[4], 'true').digest, {
    ...
    it('[3.6] Reveal - Error .hash)', async () => {
        await expectRevert.unspecified(
            IexecInstance.reveal(tasks[5], odbtools.utils.hashResult(tasks[5], 'nottrue').digest, {
                from: worker1.address,
            }),
        );
    });
    ...
    it('[3.6] Reveal - Error .seal)', async () => {
        await IexecInstance.reveal(tasks[6], odbtools.utils.hashResult(tasks[6], 'true').digest, {
            from: worker1.address,
        });
        await expectRevert.unspecified(
