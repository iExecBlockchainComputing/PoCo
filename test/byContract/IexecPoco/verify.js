...
contract('Poco', async (accounts) => {
	...
	it("check signature mechanism", async () => {
		...
		assert.isFalse      (await IexecInstance.viewPresigned(entry.hash),                                                                       "Error with the validation of signatures");
		assert.isTrue       (await IexecInstance.verifySignature(iexecAdmin,             entry.hash,               entry.sign,               {}), "Error with the validation of signatures");
		await shouldFail.reverting(IexecInstance.verifySignature(user,                   entry.hash,               entry.sign,               {}), "Error with the validation of signatures");
		await shouldFail.reverting(IexecInstance.verifySignature(constants.NULL.ADDRESS, entry.hash,               entry.sign,               {}), "Error with the validation of signatures");
		await shouldFail.reverting(IexecInstance.verifySignature(iexecAdmin,             web3.utils.randomHex(32), entry.sign,               {}), "Error with the validation of signatures");
		await shouldFail.reverting(IexecInstance.verifySignature(iexecAdmin,             constants.NULL.BYTES32,   entry.sign,               {}), "Error with the validation of signatures");
		await shouldFail.reverting(IexecInstance.verifySignature(iexecAdmin,             entry.hash,               web3.utils.randomHex(65), {}), "Error with the validation of signatures");
		await shouldFail.reverting(IexecInstance.verifySignature(iexecAdmin,             entry.hash,               constants.NULL.SIGNATURE, {}), "Error with the validation of signatures");
	});
	...
	it("check app hash", async () => {
		...
		assert.isTrue(await IexecInstance.verifySignature(appProvider, odbtools.AppOrderTypedStructHash(apporder), apporder.sign, {}), "Error with the validation of the apporder signature");
		...
		await shouldFail.reverting(IexecInstance.verifySignature(appProvider, odbtools.AppOrderTypedStructHash({ app: constants.NULL.ADDRESS, appprice: apporder.appprice, volume: apporder.volume, tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: apporder.workerpoolrestrict, requesterrestrict: apporder.requesterrestrict, salt: apporder.salt            }), apporder.sign,            {}));
		await shouldFail.reverting(IexecInstance.verifySignature(appProvider, odbtools.AppOrderTypedStructHash({ app: apporder.app,           appprice: 0,                 volume: apporder.volume, tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: apporder.workerpoolrestrict, requesterrestrict: apporder.requesterrestrict, salt: apporder.salt            }), apporder.sign,            {}));
		await shouldFail.reverting(IexecInstance.verifySignature(appProvider, odbtools.AppOrderTypedStructHash({ app: apporder.app,           appprice: apporder.appprice, volume: 0xFFFFFF,        tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: apporder.workerpoolrestrict, requesterrestrict: apporder.requesterrestrict, salt: apporder.salt            }), apporder.sign,            {}));
	...
	it("check dataset hash", async () => {
		...
		assert.isTrue(await IexecInstance.verifySignature(datasetProvider, odbtools.DatasetOrderTypedStructHash(datasetorder), datasetorder.sign, {}), "Error with the validation of the datasetorder signature");
		...
		await shouldFail.reverting(IexecInstance.verifySignature(datasetProvider, odbtools.DatasetOrderTypedStructHash({ dataset: constants.NULL.ADDRESS, datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), datasetorder.sign,        {}));
		await shouldFail.reverting(IexecInstance.verifySignature(datasetProvider, odbtools.DatasetOrderTypedStructHash({ dataset: datasetorder.dataset,   datasetprice: 0,                         volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), datasetorder.sign,        {}));
		await shouldFail.reverting(IexecInstance.verifySignature(datasetProvider, odbtools.DatasetOrderTypedStructHash({ dataset: datasetorder.dataset,   datasetprice: datasetorder.datasetprice, volume: 0xFFFFFF,            tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), datasetorder.sign,        {}));
		await shouldFail.reverting(IexecInstance.verifySignature(datasetProvider, odbtools.DatasetOrderTypedStructHash({ dataset: datasetorder.dataset,   datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: "0x1",            apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), datasetorder.sign,        {}));
		await shouldFail.reverting(IexecInstance.verifySignature(datasetProvider, odbtools.DatasetOrderTypedStructHash({ dataset: datasetorder.dataset,   datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: constants.NULL.ADDRESS,   workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), datasetorder.sign,        {}));
	...
	it("check workerpool hash", async () => {
		...
		assert.isTrue(await IexecInstance.verifySignature(scheduler, odbtools.WorkerpoolOrderTypedStructHash(workerpoolorder), workerpoolorder.sign, {}), "Error with the validation of the workerpoolorder signature");
	...
	it("check request hash", async () => {
		...
		assert.isTrue(await IexecInstance.verifySignature(user, odbtools.RequestOrderTypedStructHash(requestorder), requestorder.sign, {}), "Error with the validation of the requestorder signature");
