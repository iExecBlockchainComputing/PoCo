...
contract('Poco', async (accounts) => {
	...
	it("check signature mechanism", async () => {
		...
		await expectRevert.unspecified(IexecInstance.verifySignature(user,                   entry.hash,               entry.sign,               {}), "Error with the validation of signatures");
		await expectRevert.unspecified(IexecInstance.verifySignature(constants.NULL.ADDRESS, entry.hash,               entry.sign,               {}), "Error with the validation of signatures");
		await expectRevert.unspecified(IexecInstance.verifySignature(iexecAdmin,             web3.utils.randomHex(32), entry.sign,               {}), "Error with the validation of signatures");
		await expectRevert.unspecified(IexecInstance.verifySignature(iexecAdmin,             constants.NULL.BYTES32,   entry.sign,               {}), "Error with the validation of signatures");
		await expectRevert.unspecified(IexecInstance.verifySignature(iexecAdmin,             entry.hash,               web3.utils.randomHex(65), {}), "Error with the validation of signatures");
		await expectRevert.unspecified(IexecInstance.verifySignature(iexecAdmin,             entry.hash,               constants.NULL.SIGNATURE, {}), "Error with the validation of signatures");
	});
	...
	it("check app hash", async () => {
		...
		await expectRevert.unspecified(IexecInstance.verifySignature(appProvider, odbtools.AppOrderTypedStructHash({ app: constants.NULL.ADDRESS, appprice: apporder.appprice, volume: apporder.volume, tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: apporder.workerpoolrestrict, requesterrestrict: apporder.requesterrestrict, salt: apporder.salt            }), apporder.sign,            {}));
		await expectRevert.unspecified(IexecInstance.verifySignature(appProvider, odbtools.AppOrderTypedStructHash({ app: apporder.app,           appprice: 0,                 volume: apporder.volume, tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: apporder.workerpoolrestrict, requesterrestrict: apporder.requesterrestrict, salt: apporder.salt            }), apporder.sign,            {}));
	...
	it("check dataset hash", async () => {
		...
		await expectRevert.unspecified(IexecInstance.verifySignature(datasetProvider, odbtools.DatasetOrderTypedStructHash({ dataset: constants.NULL.ADDRESS, datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), datasetorder.sign,        {}));
		await expectRevert.unspecified(IexecInstance.verifySignature(datasetProvider, odbtools.DatasetOrderTypedStructHash({ dataset: datasetorder.dataset,   datasetprice: 0,                         volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), datasetorder.sign,        {}));
		await expectRevert.unspecified(IexecInstance.verifySignature(datasetProvider, odbtools.DatasetOrderTypedStructHash({ dataset: datasetorder.dataset,   datasetprice: datasetorder.datasetprice, volume: 0xFFFFFF,            tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), datasetorder.sign,        {}));
		await expectRevert.unspecified(IexecInstance.verifySignature(datasetProvider, odbtools.DatasetOrderTypedStructHash({ dataset: datasetorder.dataset,   datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: "0x1",            apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), datasetorder.sign,        {}));
