...
contract("Poco", async (accounts) => {
	...
	it("check signature mechanism", async () => {
		...
		assert.isTrue (await IexecInstance.verifyPresignatureOrSignature(iexecAdmin,             entry.hash,               tools.compactSignature(entry.sign), ));
		...
		assert.isFalse(await IexecInstance.verifyPresignatureOrSignature(iexecAdmin,             entry.hash,               web3.utils.randomHex(64)            ));
		assert.isFalse(await IexecInstance.verifyPresignatureOrSignature(iexecAdmin,             entry.hash,               web3.utils.randomHex(64)+"1b"       ));
		await expectRevert(  IexecInstance.verifyPresignatureOrSignature(iexecAdmin,             entry.hash,               web3.utils.randomHex(64)+"1a"       ), "invalid-signature-v");
		await expectRevert(  IexecInstance.verifyPresignatureOrSignature(iexecAdmin,             entry.hash,               constants.NULL.SIGNATURE            ), "invalid-signature-format");
	});
	...
	it("check app hash", async () => {
		...
		apporder_hash = odbtools.hashAppOrder(ERC712_domain, apporder);
		odbtools.signAppOrder(ERC712_domain, apporder, wallets.addressToPrivate(appProvider));

		assert.isTrue (await IexecInstance.verifySignature(appProvider, odbtools.hashAppOrder(ERC712_domain, apporder                                                                                                                                                                                                                                                                           ), apporder.sign                        ));
		assert.isTrue (await IexecInstance.verifySignature(appProvider, odbtools.hashAppOrder(ERC712_domain, apporder                                                                                                                                                                                                                                                                           ), tools.compactSignature(apporder.sign)));
		assert.isTrue (await IexecInstance.verifySignature(appProvider, odbtools.hashAppOrder(ERC712_domain, { app: apporder.app,           appprice: apporder.appprice, volume: apporder.volume, tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: apporder.workerpoolrestrict, requesterrestrict: apporder.requesterrestrict, salt: apporder.salt            }), apporder.sign                        ));
		assert.isFalse(await IexecInstance.verifySignature(appProvider, odbtools.hashAppOrder(ERC712_domain, { app: constants.NULL.ADDRESS, appprice: apporder.appprice, volume: apporder.volume, tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: apporder.workerpoolrestrict, requesterrestrict: apporder.requesterrestrict, salt: apporder.salt            }), apporder.sign                        ));
		assert.isFalse(await IexecInstance.verifySignature(appProvider, odbtools.hashAppOrder(ERC712_domain, { app: apporder.app,           appprice: 0,                 volume: apporder.volume, tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: apporder.workerpoolrestrict, requesterrestrict: apporder.requesterrestrict, salt: apporder.salt            }), apporder.sign                        ));
		assert.isFalse(await IexecInstance.verifySignature(appProvider, odbtools.hashAppOrder(ERC712_domain, { app: apporder.app,           appprice: apporder.appprice, volume: 0xFFFFFF,        tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: apporder.workerpoolrestrict, requesterrestrict: apporder.requesterrestrict, salt: apporder.salt            }), apporder.sign                        ));
		...
		await expectRevert(  IexecInstance.verifySignature(appProvider, odbtools.hashAppOrder(ERC712_domain, { app: apporder.app,           appprice: apporder.appprice, volume: apporder.volume, tag: apporder.tag, datasetrestrict: apporder.datasetrestrict, workerpoolrestrict: apporder.workerpoolrestrict, requesterrestrict: apporder.requesterrestrict, salt: apporder.salt            }), constants.NULL.SIGNATURE             ), "invalid-signature-format");
	});
	...
	it("check dataset hash", async () => {
		...
		datasetorder_hash = odbtools.hashDatasetOrder(ERC712_domain, datasetorder);
		odbtools.signDatasetOrder(ERC712_domain, datasetorder, wallets.addressToPrivate(datasetProvider));

		assert.isTrue (await IexecInstance.verifySignature(datasetProvider, odbtools.hashDatasetOrder(ERC712_domain, datasetorder                                                                                                                                                                                                                                                                                                   ), datasetorder.sign                        ));
		assert.isTrue (await IexecInstance.verifySignature(datasetProvider, odbtools.hashDatasetOrder(ERC712_domain, datasetorder                                                                                                                                                                                                                                                                                                   ), tools.compactSignature(datasetorder.sign)));
		assert.isTrue (await IexecInstance.verifySignature(datasetProvider, odbtools.hashDatasetOrder(ERC712_domain, { dataset: datasetorder.dataset,   datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), datasetorder.sign                        ));
		assert.isFalse(await IexecInstance.verifySignature(datasetProvider, odbtools.hashDatasetOrder(ERC712_domain, { dataset: constants.NULL.ADDRESS, datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), datasetorder.sign                        ));
		assert.isFalse(await IexecInstance.verifySignature(datasetProvider, odbtools.hashDatasetOrder(ERC712_domain, { dataset: datasetorder.dataset,   datasetprice: 0,                         volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), datasetorder.sign                        ));
		assert.isFalse(await IexecInstance.verifySignature(datasetProvider, odbtools.hashDatasetOrder(ERC712_domain, { dataset: datasetorder.dataset,   datasetprice: datasetorder.datasetprice, volume: 0xFFFFFF,            tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), datasetorder.sign                        ));
		assert.isFalse(await IexecInstance.verifySignature(datasetProvider, odbtools.hashDatasetOrder(ERC712_domain, { dataset: datasetorder.dataset,   datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: "0x1",            apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), datasetorder.sign                        ));
		assert.isFalse(await IexecInstance.verifySignature(datasetProvider, odbtools.hashDatasetOrder(ERC712_domain, { dataset: datasetorder.dataset,   datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: constants.NULL.ADDRESS,   workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), datasetorder.sign                        ));
		...
		await expectRevert(  IexecInstance.verifySignature(datasetProvider, odbtools.hashDatasetOrder(ERC712_domain, { dataset: datasetorder.dataset,   datasetprice: datasetorder.datasetprice, volume: datasetorder.volume, tag: datasetorder.tag, apprestrict: datasetorder.apprestrict, workerpoolrestrict: datasetorder.workerpoolrestrict, requesterrestrict: datasetorder.requesterrestrict, salt: datasetorder.salt        }), constants.NULL.SIGNATURE                 ), "invalid-signature-format");
	});
	...
	it("check workerpool hash", async () => {
		...
		workerpoolorder_hash = odbtools.hashWorkerpoolOrder(ERC712_domain, workerpoolorder);
		odbtools.signWorkerpoolOrder(ERC712_domain, workerpoolorder, wallets.addressToPrivate(scheduler));

		assert.isTrue (await IexecInstance.verifySignature(scheduler, odbtools.hashWorkerpoolOrder(ERC712_domain, workerpoolorder), workerpoolorder.sign));
		assert.isTrue (await IexecInstance.verifySignature(scheduler, odbtools.hashWorkerpoolOrder(ERC712_domain, workerpoolorder), tools.compactSignature(workerpoolorder.sign)));
		assert.isTrue (await IexecInstance.verifySignature(scheduler, odbtools.hashWorkerpoolOrder(ERC712_domain, { workerpool: workerpoolorder.workerpool, workerpoolprice: workerpoolorder.workerpoolprice, volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requesterrestrict: workerpoolorder.requesterrestrict, salt: workerpoolorder.salt     }), workerpoolorder.sign    ));
		assert.isFalse(await IexecInstance.verifySignature(scheduler, odbtools.hashWorkerpoolOrder(ERC712_domain, { workerpool: constants.NULL.ADDRESS,     workerpoolprice: workerpoolorder.workerpoolprice, volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requesterrestrict: workerpoolorder.requesterrestrict, salt: workerpoolorder.salt     }), workerpoolorder.sign    ));
		assert.isFalse(await IexecInstance.verifySignature(scheduler, odbtools.hashWorkerpoolOrder(ERC712_domain, { workerpool: workerpoolorder.workerpool, workerpoolprice: 0,                               volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requesterrestrict: workerpoolorder.requesterrestrict, salt: workerpoolorder.salt     }), workerpoolorder.sign    ));
		...
		await expectRevert(  IexecInstance.verifySignature(scheduler, odbtools.hashWorkerpoolOrder(ERC712_domain, { workerpool: workerpoolorder.workerpool, workerpoolprice: workerpoolorder.workerpoolprice, volume: workerpoolorder.volume, category: workerpoolorder.category, trust: workerpoolorder.trust, tag: workerpoolorder.tag, apprestrict: workerpoolorder.apprestrict, datasetrestrict: workerpoolorder.datasetrestrict, requesterrestrict: workerpoolorder.requesterrestrict, salt: workerpoolorder.salt     }), constants.NULL.SIGNATURE), "invalid-signature-format");
	});
	...
	it("check request hash", async () => {
		...
		requestorder_hash = odbtools.hashRequestOrder(ERC712_domain, requestorder);
		odbtools.signRequestOrder(ERC712_domain, requestorder, wallets.addressToPrivate(user));

		assert.isTrue (await IexecInstance.verifySignature(user, odbtools.hashRequestOrder(ERC712_domain, requestorder), requestorder.sign));
		assert.isTrue (await IexecInstance.verifySignature(user, odbtools.hashRequestOrder(ERC712_domain, requestorder), tools.compactSignature(requestorder.sign)));
		assert.isTrue (await IexecInstance.verifySignature(user, odbtools.hashRequestOrder(ERC712_domain, { app: requestorder.app,       appmaxprice: requestorder.appmaxprice, dataset: requestorder.dataset,   datasetmaxprice: requestorder.datasetmaxprice, workerpool: requestorder.workerpool, workerpoolmaxprice: requestorder.workerpoolmaxprice, volume: requestorder.volume, category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        }), requestorder.sign       ));
		assert.isFalse(await IexecInstance.verifySignature(user, odbtools.hashRequestOrder(ERC712_domain, { app: constants.NULL.ADDRESS, appmaxprice: requestorder.appmaxprice, dataset: requestorder.dataset,   datasetmaxprice: requestorder.datasetmaxprice, workerpool: requestorder.workerpool, workerpoolmaxprice: requestorder.workerpoolmaxprice, volume: requestorder.volume, category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        }), requestorder.sign       ));
		assert.isFalse(await IexecInstance.verifySignature(user, odbtools.hashRequestOrder(ERC712_domain, { app: requestorder.app,       appmaxprice: 1000,                     dataset: requestorder.dataset,   datasetmaxprice: requestorder.datasetmaxprice, workerpool: requestorder.workerpool, workerpoolmaxprice: requestorder.workerpoolmaxprice, volume: requestorder.volume, category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        }), requestorder.sign       ));
		assert.isFalse(await IexecInstance.verifySignature(user, odbtools.hashRequestOrder(ERC712_domain, { app: requestorder.app,       appmaxprice: requestorder.appmaxprice, dataset: constants.NULL.ADDRESS, datasetmaxprice: requestorder.datasetmaxprice, workerpool: requestorder.workerpool, workerpoolmaxprice: requestorder.workerpoolmaxprice, volume: requestorder.volume, category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        }), requestorder.sign       ));
		assert.isFalse(await IexecInstance.verifySignature(user, odbtools.hashRequestOrder(ERC712_domain, { app: requestorder.app,       appmaxprice: requestorder.appmaxprice, dataset: requestorder.dataset,   datasetmaxprice: 1000,                         workerpool: requestorder.workerpool, workerpoolmaxprice: requestorder.workerpoolmaxprice, volume: requestorder.volume, category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        }), requestorder.sign       ));
		assert.isFalse(await IexecInstance.verifySignature(user, odbtools.hashRequestOrder(ERC712_domain, { app: requestorder.app,       appmaxprice: requestorder.appmaxprice, dataset: requestorder.dataset,   datasetmaxprice: requestorder.datasetmaxprice, workerpool: constants.NULL.ADDRESS,  workerpoolmaxprice: requestorder.workerpoolmaxprice, volume: requestorder.volume, category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        }), requestorder.sign       ));
		assert.isFalse(await IexecInstance.verifySignature(user, odbtools.hashRequestOrder(ERC712_domain, { app: requestorder.app,       appmaxprice: requestorder.appmaxprice, dataset: requestorder.dataset,   datasetmaxprice: requestorder.datasetmaxprice, workerpool: requestorder.workerpool, workerpoolmaxprice: 1000,                            volume: requestorder.volume, category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        }), requestorder.sign       ));
		assert.isFalse(await IexecInstance.verifySignature(user, odbtools.hashRequestOrder(ERC712_domain, { app: requestorder.app,       appmaxprice: requestorder.appmaxprice, dataset: requestorder.dataset,   datasetmaxprice: requestorder.datasetmaxprice, workerpool: requestorder.workerpool, workerpoolmaxprice: requestorder.workerpoolmaxprice, volume: 0xFFFFFF,            category: requestorder.category, trust: requestorder.trust, tag: requestorder.tag, requester: requestorder.requester, beneficiary: requestorder.beneficiary, callback: requestorder.callback, params: requestorder.params, salt: requestorder.salt        }), requestorder.sign       ));
