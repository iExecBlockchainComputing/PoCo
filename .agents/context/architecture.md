...
-   Shared helpers: `contracts/abstract/` for inherited bases (`FacetBase`, `IexecEscrow`) and `contracts/libs/` for stateless helper libraries (`CommonLib`, `PocoStorageLib`, …)
