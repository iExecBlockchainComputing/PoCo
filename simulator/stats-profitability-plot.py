...
pwd_out = "/home/amxx/Work/iExec/sandbox/simulator/plots"
###############################################################################
...
if __name__ == '__main__':
	...
	for target in targets:
		for f in funds:
			data = np.load("%s/profitability.fund-%.2f.trg-%f.npy" % (pwd_in, f, target))
			initPlot()
			...
			endPlot("%s/profitability.fund-%.2f.trg-%f.png" % (pwd_out, f, target))
			# endPlot()
