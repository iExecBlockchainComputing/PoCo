...
async function main() {
    ...
    const depositAndMatchFacet = await deployNewFacet(
        deployer,
        chainId,
...
async function deployNewFacet(deployer: any, chainId: bigint, iexecLibOrdersAddress: string) {
...
async function checkDiamondState(diamondProxyAddress: string) {
